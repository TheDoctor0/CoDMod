...
#define PLUGIN "CoD Item Generator Rakiet"
#define VERSION "1.0.0"
#define AUTHOR "O'Zone"

#define NAME        "Generator Rakiet"
#define DESCRIPTION "Co %s sekund dostajesz rakiete."
#define RANDOM_MIN  10
#define RANDOM_MAX  15
#define UPGRADE_MIN -3
#define UPGRADE_MAX 2

#define TASK_ITEM 80323
...
{
	cod_set_user_rockets(id, ITEM, 0);
...
public generate_item(id)
{
	...
	cod_add_user_rockets(id, ITEM, 1);
}