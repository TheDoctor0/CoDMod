...
new const perk_name[] = "Zlote ak";
new const perk_desc[] = "Dostajesz zlote ak oraz + 20dmg z niego";
...
{
	precache_model("models/zlote_bronie/w_ak47.mdl");
	precache_model("models/zlote_bronie/p_ak47.mdl");
	precache_model("models/zlote_bronie/v_ak47.mdl");
}
...
public CurWeapon(id)
{
	...
	if(weapon == CSW_AK47)
	{
	set_pev(id, pev_viewmodel2, "models/zlote_bronie/v_ak47.mdl")
	set_pev(id, pev_weaponmodel2, "models/zlote_bronie/p_ak47.mdl")
	}
	}
}
...
public fw_SetModel(entity, model[])
{
	...
	engfunc(EngFunc_SetModel, entity, "models/zlote_bronie/w_ak47.mdl")
