...
new const perk_name[] = "Ghost Sniper I";
new const perk_desc[] = "Dostajesz scouta, 50 widocznosci na nim, 550 grawitacji";
...
public cod_perk_enabled(id)
{
	...
	cod_give_weapon(id, CSW_SCOUT)
 	entity_set_float(id, EV_FL_gravity, 55.0/80.0);
}
...
public fwHamItemDeploy(ent)
{
	...
	if(cs_get_weapon_id(ent) == CSW_SCOUT)
