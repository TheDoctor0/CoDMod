...
new const commandHonor[][] = { "przelejh", "say /przelewh", "say_team /przelewh", "say /przelejh", "say_team /przelejh" };
new const commandCash[][] = { "przelejc", "say /przelewc", "say_team /przelewc", "say /przelejc", "say_team /przelejc" };
...
public transfer_honor_menu(id)
{
	...
	new menuData[256], playerName[MAX_NAME], playerId[3], players, menu = menu_create("\yWybierz \rGracza\y, ktoremu chcesz przelac \rHonor\w:", "transfer_honor_menu_handle");
...
public transfer_cash_menu(id)
{
	...
	new menuData[256], playerName[MAX_NAME], playerId[3], players, menu = menu_create("\yWybierz \rGracza\y, ktoremu chcesz przelac \rKase\w:", "transfer_cash_menu_handle");
