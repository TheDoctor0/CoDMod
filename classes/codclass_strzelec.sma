...
#define DESCRIPTION  "Ma 10 procent szansy na natychmiastowe zabicie z M4A1/AK47, dodatkowo posiada 1 mine."
...
{
	if ((weapon == CSW_M4A1 || weapon == CSW_AK47) && damageBits & DMG_BULLET && cod_percent_chance(10)) {
