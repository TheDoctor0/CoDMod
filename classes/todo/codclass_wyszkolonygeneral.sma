...
new const nazwa[]   = "Wyszkolony Genera³ (Premium)";
new const opis[]    = "Posiada 3 rakietki, 1/4 z He, mo¿e wykonaæ skok w powietrzu";
...
public cod_class_enabled(id)
{
	...
	{
		client_print(id, print_chat, "[Wyszkolony Genera³ (Premium)] Nie masz uprawnien, aby uzywac tej klasy.")
		return COD_STOP;
	}
