...
new const nazwa[]   = "Kleryk(Premium)";
new const opis[]    = "2 rakiety, malo Widoczny gdzy kuca na nozu";
new const bronie    = (1<<CSW_HEGRENADE)|(1<<CSW_ELITE)|(1<<CSW_FAMAS)|(1<<CSW_AK47);
