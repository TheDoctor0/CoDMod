...
new const opis[]    = "Ma 1 dynamit, +4 dmg z aug";
new const bronie    = (1<<CSW_AUG)|(1<<CSW_GLOCK18)|(1<<CSW_FLASHBANG);
new const zdrowie   = 15;
new const kondycja  = 5;
new const inteligencja = 5;
new const wytrzymalosc = 15;
    
new dynamit_gracza[33], ilosc_dynamitow_gracza[33], sprite_blast_dynamit, sprite_white_dynamit, bool:ma_klase[33];
