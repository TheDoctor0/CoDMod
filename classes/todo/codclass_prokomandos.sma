...
new const nazwa[]   = "ProKomandos";
new const opis[]    = "Posiada m4 i 1 apteczke ma 1/1 z no¿a oraz 2 fleshe i podwójny skok";
...
public cod_class_enabled(id)
{
	...
	{
		client_print(id, print_chat, "[ProKomandos] Nie masz uprawnien, aby uzywac tej klasy.")
		return COD_STOP;
	}
