...
new const nazwa[]   = "Amadeusz [P]";
new const opis[]    = "1/12 z mp5, 2 rakiety, 3 skoki, 1/1 z he";
new const bronie    = (1<<CSW_MP5NAVY)|(1<<CSW_FLASHBANG)|(1<<CSW_FLASHBANG)|(1<<CSW_SMOKEGRENADE)|(1<<CSW_HEGRENADE);
