...
new const nazwa[]   = "Moderator(premium)";
new const opis[]    = "Posiada M4/AWP/Deagle/HE/FLASH, ma 1/10 na wyrzucenie broni przeciwnika, 1 rakieta";
new const bronie    = (1<<CSW_HEGRENADE)|(1<<CSW_AWP)|(1<<CSW_M4A1)|(1<<CSW_FLASHBANG)|(1<<CSW_DEAGLE);
...
public cod_class_enabled(id)
{
	...
	{
		client_print(id, print_chat, "[Moderator(premium)] Nie masz uprawnien, aby uzywac tej klasy.")
		return COD_STOP;
	}
