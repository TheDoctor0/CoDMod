...
new const opis[]    = "Ma m4 i elites oraz 1/3 z HE i he co 15 sek. 2 apteczki i podwójny skok!";
new const bronie    = (1<<CSW_HEGRENADE)|(1<<CSW_ELITE)|(1<<CSW_M4A1);
...
public cod_class_enabled(id)
{
	...
	{
		client_print(id, print_chat, "[Terminator] Nie masz uprawnien, aby uzywac tej klasy.")
		return COD_STOP;
	}

	ilosc_apteczek_gracza[id] = 2;
	give_item(id, "weapon_hegrenade");
	set_task(15.0, "granaty", id, _, _, "b")
	ma_klase[id] = true;
